        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-16">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/etudi.tn"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 hover:scale-110 transition-all group"
              >
              ...
              <a
                href="https://www.instagram.com/etudi.tn"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/company/etudi-tn"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 hover:scale-110 transition-all group"
              ...
              <a
                href="https://www.youtube.com/@etudi.tn"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 hover:scale-110 transition-all group"
          ...
          <div className="text-center text-xs text-gray-600 border-t border-gray-800 pt-8">
            <p>© 2026 ETUDI. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
